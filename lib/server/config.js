...
export const getRuntimeConfig = () => {
  ...
  // This codebase does not yet contain the decoded, simulated, budgeted and
  // receipt-reconciled UserOperation submission adapter. An environment value
  // alone must never make secondary actions appear executable.
