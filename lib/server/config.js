...
export const getRuntimeConfig = () => {
  ...
  const secondaryReconciliationConfigured = Boolean(seaportAddress && usdcAddress);
...
export const requireSecondaryIndexerConfig = () => {
  const config = getRuntimeConfig();
  if (config.secondary.infrastructureConfigured) return config;
  throw new ConfigurationError("The secondary-market indexer is not configured.", [
    "GROVE_SECONDARY_ENABLED=true",
    "finalized Seaport, USDC, RPC, and database configuration"
  ]);
};
